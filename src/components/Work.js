      ...
      <div className="container">
        ...
        >
          <div className="box">
            ...
            <div className="box-text">
              <p>
                "Feastful Finds" is a recipe website that aims to make meal
                planning and preparation a breeze. With our easy-to-use
                platform, you can enter the ingredients you have on hand and
                receive a variety of recipe ideas that will help you make the
                most of what you already have. No more waste, no more searching
        ...
        <a className="button" href="https://calm-brook-30132.herokuapp.com/">
          <div className="box">
            ...
            <div className="box-text">
              <p>
                EatsMatch, is the place to go to save money when ordering in. No
                need to search through all the services to find the best price
                and coupon codes - EatsMatch allows users to compare food
